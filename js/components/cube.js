export function createCubeAnimation(containerSelector) {
        ...
        <svg width="512" height="512" viewBox="0 0 512 512" fill="none" overflow="hidden" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                <g id="cube">
                    ...
                    <use href="#cube_outline" stroke-linejoin="round" stroke-width="6" stroke="var(--cube-outline)"/>
                </g>	
                ...
                <linearGradient id="fade" gradientTransform="rotate(90)">
                    <stop offset="0" style="stop-color: var(--cube-fade-top)"/>
                    <stop offset="0.25" style="stop-color: var(--cube-fade-bottom)"/>
                </linearGradient>
                <linearGradient id="sky" gradientTransform="rotate(90)">
                    <stop offset="0.5" style="stop-color: var(--cube-sky-top)"/>
                    <stop offset="1" style="stop-color: var(--cube-sky-bottom)"/>
                </linearGradient>
